...
public class Dashboard extends JFrame implements ActionListener{
    ...
    JButton addPersonalDetails, updatePersonalDetails, viewPersonalDetails, deletePersonalDetails,
            checkpackages, bookpackages, viewpackages, viewhotels, destinations, bookhotels;
    ...
    Dashboard(String username) {
        ...
        bookpackages.setBackground(new Color(0, 0, 50));
        ...
        viewhotels.setBackground(new Color(0, 0, 50));
        ...
        bookhotels.setBackground(new Color(0, 0, 50));
        ...
        viewbookedhotels.setBackground(new Color(0, 0, 50));
        ...
        payments.setBackground(new Color(0, 0, 50));
        ...
        calculator.setBackground(new Color(0, 0, 50));
        ...
        notepad.setBackground(new Color(0, 0, 50));
        ...
        about.setBackground(new Color(0, 0, 50));
